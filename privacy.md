...
On successful deletion, Safi shows a deletion reference ID, signs you out, and returns you to the login screen.
...
Safi is intended for users who are legally able to work as drivers or manage driving-related income and expenses.

Safi is not intended for children.

Safi is not intended for users under 13 years old, or under the minimum age required by local law to use the app independently.

If you believe a child submitted personal data to Safi, contact us so we can take appropriate action.
